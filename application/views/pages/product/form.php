				...
				<div class="card-body">
					<?= form_open_multipart($form_action, ['method' => 'POST']) ?>
						...
						<div class="form-group">
							...
							<?= form_input(['type' => 'text', 'name' => 'tokopedia', 'value' => $input->tokopedia, 'class' => 'form-control', 'required' => true]) ?>
							<?= form_error('tokopedia') ?>
						</div>
						<div class="form-group">
							<label for="">Link Shopee</label>
							<?= form_input(['type' => 'text', 'name' => 'shopee', 'value' => $input->shopee, 'class' => 'form-control', 'required' => true]) ?>
							<?= form_error('shopee') ?>
						</div>
						<div class="form-group">
